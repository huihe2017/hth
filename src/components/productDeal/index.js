...
class DealTerrace extends React.Component{
    render(){
        let data= [
            {
                title:'外汇交易的特点：',
                content:['外汇交易就是一国货币与另一国货币进行交换。与其他金融市场不同，外汇市场没有具体地点，也没有中央交易所，而是通过银行、企业和个人间的电子网络进行交易。 "外汇交易"是同时买入一对货币组合中的一种货币而卖出另外一种货币。 外汇是以货币兑换形式交易， 例如欧元/美元(EUR/USD)或美元/日元 (USD/JPY)。',
                    ...
                    '外汇市场不受景气影响，没有涨跌幅的限制，投资者可根据其对某种货币未来行情走势的预测，同时进行做多或做空的交易策略，享受交易的灵活性。外汇市场的主要参与者包含全球各国中央银行、商业或投资银行、外汇经纪商、自营商、进出口商、跨国企业、基金公司、投机交易者等等。'
                ]
            }
        ]
